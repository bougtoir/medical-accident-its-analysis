...
ABSTRACT = (
    "Background: Archaic-like segments near focal loci such as the ABO "
    ...
    "Methods: High-confidence archaic-introgression calls from "
    ...
    "route-level signal. Conclusion: Population-level archaic-segment sharing "
