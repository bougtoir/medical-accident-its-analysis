...
METHODS = [
    ...
    (
        ...
        [
            (
                "Ancient ABO-window observations were secondarily extracted from "
                "public outputs associated with the Neanderthal-ancestry-through-time "
...
FIGURES = {
    ...
    8: (
        ...
        "Descriptive ancient and modern ABO-window summaries. Ancient observations were secondarily extracted from public outputs associated with Iasi et al. (2024); modern calls use hmmix. Different pipelines and coverage preclude a formal temporal comparison.",
    ),
    9: (
