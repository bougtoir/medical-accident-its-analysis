"""
Definition E (5-HT3 antagonist-based) full analysis:
  - Primary: 5-HT3 antagonist use at any time (ondansetron or granisetron > 0)
  - Secondary: 5-HT3 antagonist use AND antiemetic before delivery (ae_to_delivery=1)
  - Covariate sensitivity analysis
  - Figures (English labels)
  - Japanese manuscript

Reuses data loading from sensitivity_analysis.py pipeline.
"""
...
# ============================================================
# 1. DATA LOADING (same pipeline)
# ============================================================
print("=" * 60)
print("DEFINITION E ANALYSIS: Loading data")
print("=" * 60)
...
# ============================================================
# 3. TABLE 1: PATIENT CHARACTERISTICS (same as main analysis)
# ============================================================
print("\n" + "=" * 60)
print("3. TABLE 1: PATIENT CHARACTERISTICS")
print("=" * 60)
...
cat_vars = [("emergency", "Emergency CS"), ("prior_cs", "Prior CS"),
            ("HDP", "HDP"), ("preop_steroid", "Preoperative steroid"),
...
# ============================================================
# 5. COVARIATE SENSITIVITY ANALYSIS (Definition E Primary)
# ============================================================
print("\n" + "=" * 60)
print("5. COVARIATE SENSITIVITY ANALYSIS — Definition E Primary")
print("=" * 60)
...
cov_sensitivity.append({
    "Model": "Reduced (6 covariates)", "n_covariates": 5,
    "aOR": float(np.exp(m.params.iloc[1])),
    "CI_lower": float(np.exp(m.conf_int().iloc[1, 0])),
    "CI_upper": float(np.exp(m.conf_int().iloc[1, 1])),
    "P": float(m.pvalues.iloc[1]),
...
# ============================================================
# 6. FIGURES (English labels)
# ============================================================
print("\n" + "=" * 60)
print("6. GENERATING FIGURES")
print("=" * 60)

# --- Fig 1: IONV rates comparison (A vs E, Singleton vs Twin) ---
...
# --- Fig 2: Forest plot — E-Primary regression ---
e_primary_result = regression_results["E-Primary"]
...
plt.tight_layout()
plt.savefig(FIG / "fig2_forest_E_primary.png")
plt.close()
print("Fig 2 saved")
...
# --- Fig 4: Protocol vs Definition E comparison forest ---
...
plt.tight_layout()
plt.savefig(FIG / "fig4_protocol_vs_defE.png")
plt.close()
print("Fig 4 saved")
...
print("\nSummary JSON saved")
print("\n" + "=" * 60)
print("DEFINITION E ANALYSIS COMPLETE")
print("=" * 60)
