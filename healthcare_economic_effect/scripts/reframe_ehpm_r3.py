...
def reframe_manuscript():
    ...
    targeted_replacements = [
        ...
        (
            ...
            "We compiled healthcare sector I-O output multipliers for 13 OECD countries from published national and EU-28 framework studies. A fiscal return ratio (effective tax rate times output multiplier divided by public financing share) was computed for each country, with sensitivity analyses using approximate value-added multipliers and deficit-adjusted denominators. A self-contained tempo model (39 countries, 2000-2019) tested for a constant spending-to-outcome lag in health-capital accumulation; model selection used LOOCV RMSE, AIC, and BIC. Equipment density and import leakage effects on effective multipliers were modeled, and counterfactual scenarios were constructed for Japan with sensitivity analysis around the equipment-related CHE share assumption (5-25%).",
        ),
        (
