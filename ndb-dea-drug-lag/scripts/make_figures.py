...
LAB = {
    "en": dict(
        ...
        y2="DAA dispensed quantity (units, millions)",
        peg="Peginterferon (syringes)", rbv="Ribavirin (capsules)",
        daa="DAA total (all products)",
        xlab="Fiscal year",
        title2="The DAA wave: dispensed quantity by product (Japan, NDB Open Data)",
        y2b="Dispensed quantity (units, millions)",
        note="Metric: NDB 処方数量 (dispensed quantity). Units differ across products.",
    ),
    "ja": dict(
        ...
        daa="DAA合計（全製剤）",
        xlab="年度",
        title2="DAAの波：製剤別処方数量（日本, NDBオープンデータ）",
        y2b="処方数量（百万単位）",
