#!/usr/bin/env python3
"""Create STROBE checklist (cross-sectional studies) for Health Policy submission.
...
def get_manuscript_page_ranges():
    ...
    """
    manuscript = os.path.join(OUTPUT_DIR, 'regional_anaesthesia_Health_Policy_EN.docx')
...
out = os.path.join(OUTPUT_DIR, 'STROBE_checklist_Health_Policy_EN.docx')
doc.save(out)
print(f"Saved: {out}")
