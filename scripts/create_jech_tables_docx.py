#!/usr/bin/env python3
"""Create separate editable tables .docx for Journal of Epidemiology & Community Health submission.
...
out_en = os.path.join(OUTPUT_DIR, 'regional_anaesthesia_tables_JECH_EN.docx')
doc.save(out_en)
