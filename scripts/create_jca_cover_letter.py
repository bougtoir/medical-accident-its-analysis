#!/usr/bin/env python3
"""Create English cover letter for Journal of Clinical Anesthesia submission."""
import json
import os
...
add_para("Journal of Clinical Anesthesia")
add_para("Elsevier")
doc.add_paragraph()
...
add_para(
    ...
    "claims-audit sensitivity\" for possible publication in the Journal of "
    "Clinical Anesthesia as a Research Paper.")
...
add_para(
    ...
    "predominantly structural -- driven by access to university hospitals -- "
    ...
    "policy. We therefore believe the paper is a strong fit for the Journal's "
    "interest in clinical anaesthesia practice, quality of care and "
...
add_para(
    ...
    "Journal of Clinical Anesthesia. The study used publicly available "
...
add_para(
    "The manuscript is within the Journal of Clinical Anesthesia limits for a "
    "Research Paper (main text approximately 3,000 words; structured abstract "
    "within 300 words; 3 tables and 2 figures combined; 21 references). We have "
...
out = os.path.join(OUTPUT_DIR, 'cover_letter_JCA_EN.docx')
doc.save(out)
print(f"Saved: {out}")
