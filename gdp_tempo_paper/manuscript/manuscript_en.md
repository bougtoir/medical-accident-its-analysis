...
- Tempo drift in time-to-build explains up to 30% of TFP-growth variance
- Out-of-sample GDP forecast error falls 13% with no new data
...
- Demographic tempo framework transplanted to capital accounting
