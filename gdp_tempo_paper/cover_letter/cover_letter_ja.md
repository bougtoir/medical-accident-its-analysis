...
このたび貴誌 *Journal of Economic Dynamics and Control* に Article として、下記の原稿を投稿いたします。
...
- 文章の整形・語感調整・コード作成支援に生成 AI を使用しました。Elsevier の生成 AI ポリシーに従い、タイトルページにて開示しています。
